...
export const IPC_PRODUCT_COVERAGE = {
  ...
  ASSETS_BUILTIN_TOOL_OCCUPANCY: excluded('Settings occupancy estimate from builtin tool schemas.'),
  ...
  BROWSER_SET_LOCKED: excluded('Side panel browser take-control; renderer UI only.'),
