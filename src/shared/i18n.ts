...
export const zhTranslations: Record<string, string> = {
  ...
  'Show the current memory injection': '查看当前记忆注入',
  'File counts and Phase 2 watermark': '文件数与 Phase 2 水位',
  'Enabled flag, cwd, and dirty state': '开关、工作目录与待合并标记',
  'Delete this project memory root': '删除本项目记忆根',
  'Queue consolidation for next spawn': '排队，下次启动再合并',
  working: '推进中',
  paused: '已暂停',
  waiting: '等待中',
  blocked: '受阻',
  ...
  'Capture lessons with learn; idle sessions merge into MEMORY.md after startup.':
    '用 learn 记下要点；空闲历史会话会在启动后合并进 MEMORY.md。',
  ...
  'Clear project memory?': '清空本项目记忆？',
  'Merge queued': '已排队合并',
  'Merging…': '合并中…',
  Ready: '就绪',
  Empty: '空',
  Lessons: '要点',
  'Merged sessions': '已合并会话',
  Size: '体积',
  'Working summary': '工作摘要',
  'Nothing consolidated yet. Idle sessions merge after the next spawn.':
    '还没有合并结果。空闲会话会在下次启动后写入。',
  'Recent lessons': '最近要点',
  'No learn captures yet. The agent writes them with the learn tool.':
    '还没有 learn 记录。助手会用 learn 工具写入。',
  'Queue merge': '排队合并',
  'MEMORY.md is present for this project.': '本项目已有 MEMORY.md。',
  'No MEMORY.md yet — waiting for idle history.': '还没有 MEMORY.md，等空闲历史合并。',
  'Memory data cleared.': '记忆已清空。',
  'Queued for the next parent spawn.': '已排队，下次父会话启动后合并。',
