...
export const zhTranslations: Record<string, string> = {
  ...
  Ready: '就绪',
  Idle: '空闲',
  '{{lessons}} lessons · {{merged}} merged · {{size}}':
    '{{lessons}} 条要点 · {{merged}} 次合并 · {{size}}',
  'Idle sessions write a summary after the next spawn.': '空闲会话会在下次启动后写入摘要。',
  'Queue merge': '排队合并',
  'Already queued': '已排队',
  'Memory data cleared.': '记忆已清空。',
  'Queued for the next parent spawn.': '下次父会话启动后合并。',
